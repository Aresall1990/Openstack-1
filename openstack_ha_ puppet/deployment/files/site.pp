...
$memcached_servers = ["${controller_virtual_ip}:11211",]
...
$allowed_hosts = ['172.0.0.1', '172.17.2.201', '172.17.2.91', '172.17.2.51', '172.17.2.52', '172.17.2.81', '172.17.2.92']
